...
export const authApi = {
  ...
  registerApi: (data: RegisterRequestDto) => {
    return axiosClient.post<RegisterResponseDto>(
  ...
  logOut: () => {
    return axiosClient.post("/api/admin/auth/logout");
  },
  googleLogin: (auth0Token: string) => {
    return axiosClient.post("/api/admin/auth/google_login", auth0Token);
  },
};
